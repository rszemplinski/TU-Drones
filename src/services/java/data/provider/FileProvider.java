package services.java.data.provider;
 ...
 * element to your app manifest. Set the <code>java:name</code> attribute to
 * <code>java.support.v4.content.FileProvider</code>. Set the <code>java:authorities</code>
 ...
 * <code>com.mydomain.fileprovider</code>. Set the <code>java:exported</code> attribute to
 ...
 * >java:grantUriPermissions</a> attribute to <code>true</code>, to allow you
 ...
 *        ...
 *        &lt;provider
 *            java:name="java.support.v4.content.FileProvider"
 *            java:authorities="com.mydomain.fileprovider"
 *            java:exported="false"
 *            java:grantUriPermissions="true"&gt;
 *            ...
 *        &lt;/provider&gt;
 *        ...
 *    &lt;/application&gt;
 ...
 * the FileProvider class and use the fully-qualified class name in the <code>java:name</code>
 ...
 * <pre class="prettyprint">
 *&lt;paths xmlns:java="http://schemas.android.com/apk/res/android"&gt;
 ...
 * <code>&lt;meta-data&gt;</code> element's "java:name" attribute to
 * <code>java.support.FILE_PROVIDER_PATHS</code>. Set the element's "java:resource" attribute
 ...
 *    java:grantUriPermissions="true"&gt;
 *    &lt;meta-data
 *        java:name="java.support.FILE_PROVIDER_PATHS"
 *        java:resource="&#64;xml/file_paths" /&gt;
 *&lt;/provider&gt;
 *</pre>
...
public class FileProvider extends ContentProvider {
    ...
    private static final String
            META_DATA_FILE_PROVIDER_PATHS = "java.support.FILE_PROVIDER_PATHS";
